...
Then open `examples/coral-ui-demo.html`, `examples/coral-explorer-demo.html`, or `examples/reef-fidelity-demo.html` in a browser.
...
- `reef-fidelity-demo.html` is generated by `npm run demo:ui` with embedded read-time reef data from seeded captures across stocks, news, docs, filings, and social discussion.
...
`npm run demo:ui` writes browser-ready visualization demos to `examples/coral-ui-demo.html`, `examples/coral-explorer-demo.html`, and `examples/reef-fidelity-demo.html`.
